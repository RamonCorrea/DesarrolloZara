...
namespace ProyectoFinal
{
    public partial class WebForm1 : System.Web.UI.Page
    {
            ...
            {         
                ...
                for (int x = 0; x < 7; x++)
                {
                    ...
                    if (contadorTurnos >= turnosEmpleado.Count)
                    {
                        ...
                        tur.Text = "Sin Turno";
                        tur.Attributes.Add("OnClick", "Open('" + tur.Text + "','" + ListaUsuario.Rows[rows].Cells[x].Text + "','" + txtFecha.Text + "','" + Session["CodEmple"] + "','" + lblNombre.Text + "','" + Login.Cod_Empresa + "')");
        ...
        //public string convierteUsuario(string user)
        //{
        //    string salida;
